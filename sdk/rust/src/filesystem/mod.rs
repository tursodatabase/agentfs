...
///
/// This trait is implemented by different filesystem backends:
/// - `AgentFS` - SQLite-backed virtual filesystem
/// - `OverlayFS` - Copy-on-write overlay combining base + delta
/// - `HostFS` - Passthrough to host directory
/// - Future: `GitFS`, `OneDriveFS`, etc.
#[async_trait]
